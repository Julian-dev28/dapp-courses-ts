...
Lets take a look at `components/organisms/pledge/index.tsx`
...
- A function which contains side effects. Here, it's updating our state variables: `tokenBalance` and `targetReached`.

...
## Checkpoint 3: 🎨 Building the Frontend
...
```sh
Vercel CLI 30.1.1
🔍  Inspect: https://vercel.com/julian-dev28/soroban-example-dapp/9Kb4JsJgQRRmi5VFkx6AvScWbBnU [3s]
✅  Preview: https://soroban-example-dapp-julian-dev28.vercel.app [2m]
📝  To deploy to production (soroban-example-dapp-iota.vercel.app), run `vercel --prod`
```
